...
const { analyzeJSTS, clearTypeScriptESLintParserCaches, createAndSaveProgram, createProgramOptions, deleteProgram, initializeLinter, writeTSConfigFile, } = require('@sonar/jsts');
