...
exports.writeTSConfigFile = exports.isRoot = exports.isRootNodeModules = exports.deleteProgram = exports.getProgramById = exports.createAndSaveProgram = exports.createProgram = exports.createProgramOptions = void 0;
...
function createProgramOptions(tsConfig, tsconfigContents) {
    ...
    if (config.error) {
        (0, helpers_1.error)(`Failed to parse tsconfig: ${tsConfig} (${diagnosticToString(config.error)})`);
...
function createProgram(tsConfig, tsconfigContents) {
    ...
    const inputProjectReferences = (_a = program.getProjectReferences()) !== null && _a !== void 0 ? _a : [];
    ...
    for (const reference of inputProjectReferences) {
        ...
        if (!sanitizedReference) {
            (0, helpers_1.warn)(`Skipping missing referenced tsconfig.json: ${reference.path}`);
        }
        else {
    ...
    function exceptions(filename) {
        ...
        /* Node modules */
        if ((0, helpers_1.toUnixPath)(dir).split('/').includes('node_modules')) {
            return false;
        }
        return true;
    }
