    ...
    return [
        {
            ...
            fix: fixer => [
                ...
                (0, helpers_1.removeNodeWithLeadingWhitespaces)(context, duplicateDecl, fixer),
            ],
        },
    ];
}
...
function getFirstMatchingImportDeclaration(module, context) {
    return context.sourceCode.ast.body.find(node => node.type === 'ImportDeclaration' && module === getModule(node));
}
