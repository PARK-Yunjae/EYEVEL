    ...
    for (const token of tokens) {
        switch (token.type) {
            ...
            case 'Identifier': {
                ...
                // @ts-ignore
                if (token.value === 'type' && (node === null || node === void 0 ? void 0 : node.type) === 'TSTypeAliasDeclaration') {
                    highlight(token, 'KEYWORD', highlights);
                }
                // @ts-ignore
                if (token.value === 'as' && (node === null || node === void 0 ? void 0 : node.type) === 'TSAsExpression') {
                    highlight(token, 'KEYWORD', highlights);
                }
                break;
            }
