...
async function run() {
    ...
    const prompt2 = "다음은 "+name+"지역을 방문할 때 추천되는 장소들에 대한 설명입니다: " + completeText + " 이 설명을 바탕으로, 추천 장소의 이름만을 쉼표(,)로 구분하여 나열해주세요. 예를 들어, '장소1, 장소2, 장소3'과 같이 작성해주십시오. 장소 이름은 가능한 한 구글 지도에서 정확히 찾을 수 있는 형태로 제공해주세요. " + name+"지역에서 너무 먼 곳이나 지도에 표시되지 않는 곳은 제외합니다."
